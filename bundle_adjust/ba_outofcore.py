...
def run_out_of_core_bundle_adjustment(self, timeline_indices, reset=False, verbose=True,
    ...
    local_sweep_args = [([t_idx], ba_dir, ba_dir, 0, None, True,
                         self.tracks_config, self.tracks_config['verbose local'], True) for t_idx in
                        timeline_indices]
    ...
    running_time, n_tracks, ba_e, init_e = self.bundle_adjust(timeline_indices, ba_dir, ba_dir, 0,
                                                              self.ba_input_data,
